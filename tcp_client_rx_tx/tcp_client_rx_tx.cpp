...
private:
    ...
    // void tcp_handle_receive(const boost::system::error_code& error, size_t bytes_transferred) {
    //     if (error) {
    ...
    // }
    // void read_msg_tcp(){
    //     socket_.async_receive(boost::asio::buffer(data_, sizeof(data_)), sender_endpoint_,
    //       boost::bind(&TCPClient::tcp_handle_receive, this, boost::asio::placeholders::error, 
